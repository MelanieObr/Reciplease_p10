...
final class CoreDataManagerTests: XCTestCase {
    ...
    func testAddRecipeToFavoritesMethods_WhenAnEntityIsCreated_ThenShouldBeCorrectlySaved() {
        coreDataManager.addRecipeToFavorites(name: "Chicken Vesuvio", image: Data(), ingredientsDescription: "", recipeUrl: "http://www.recipes.com/recipes/8793/", time: "")
    ...
    func testDeleteOneRecipeMethod_WhenEntityIsDeleted_ThenShouldBeCorrectlyDeleted() {
        coreDataManager.addRecipeToFavorites(name: "Chicken Vesuvio", image: Data(), ingredientsDescription: "", recipeUrl: "http://www.recipes.com/recipes/8793/", time: "")
       coreDataManager.addRecipeToFavorites(name: "Strong Cheese", image: Data(), ingredientsDescription: "", recipeUrl: "http://www.recipes.com/recipes/8793/", time: "")
